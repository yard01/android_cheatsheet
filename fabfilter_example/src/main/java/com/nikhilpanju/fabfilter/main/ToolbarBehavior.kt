...
class ToolbarBehavior : CoordinatorLayout.Behavior<AppBarLayout>() {
    ...
    private fun getViews(child: AppBarLayout) {
        ...
        toolbar = child.findViewById(R.id.ui_fabfilter_appbar_container)
        toolbarTitle = toolbar.findViewById(R.id.ui_fabfilter_toolbar_title)
        drawerIcon = toolbar.findViewById(R.id.ui_fabfilter_drawer_icon)
