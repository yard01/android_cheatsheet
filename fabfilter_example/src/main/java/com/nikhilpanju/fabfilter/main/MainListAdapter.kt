...
class MainListAdapter(context: Context) : RecyclerView.Adapter<MainListAdapter.ListViewHolder>() {
    ...
    private val originalBg: Int by bindColor(context, R.color.ui_fabfilter_list_item_bg_collapsed)
    private val expandedBg: Int by bindColor(context, R.color.ui_fabfilter_list_item_bg_expanded)

    private val listItemHorizontalPadding: Float by bindDimen(context, R.dimen.ui_fabfilter_list_item_horizontal_padding)
    private val listItemVerticalPadding: Float by bindDimen(context, R.dimen.ui_fabfilter_list_item_vertical_padding)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder =
            ListViewHolder(inflater.inflate(R.layout.ui_fabfilter_item_list, parent, false))
    ...
    class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val expandView: View by bindView(R.id.ui_fabfilter_expand_view)
        val chevron: View by bindView(R.id.ui_fabfilter_chevron)
        val cardContainer: View by bindView(R.id.ui_fabfilter_card_container)
        val scaleContainer: View by bindView(R.id.ui_fabfilter_scale_container)
        val listItemFg: View by bindView(R.id.ui_fabfilter_list_item_fg)
    }
}