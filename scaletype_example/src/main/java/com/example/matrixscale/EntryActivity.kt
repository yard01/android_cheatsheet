...
class EntryActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.scaletype_example_activity_entry)
...
enum class ImagesTypeEnum(val descriptor: String, @DrawableRes val imageId: Int) {
    BIGGER("Bigger Image - Fall", R.drawable.scaletype_example_fall),
    SMALLER("Smaller Image - Lion", R.drawable.scaletype_example_lion),
    TALLER("Taller Image - Tree", R.drawable.scaletype_example_tree),
    LONGER("Longer Image - Bridge", R.drawable.scaletype_example_bridge),
    JUMP("Tall Image - Jump", R.drawable.scaletype_example_jump),
    ATHLETIC("Long Image - Track", R.drawable.scaletype_example_athletic);
